import { getStaticProps as getStaticPropsHandler } from 'dataFetching/page/thai-livescore';
...
import { Mobile as ThailandLivescoreMobile } from 'components/Pages/ThailandLivescore';
...
function Component(props: Props) {
  return (
    <Layout menu={props.menu}>
      {props.page && <ThailandLivescoreMobile {...props} />}
    </Layout>
  );
}
