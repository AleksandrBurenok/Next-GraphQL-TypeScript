import { getStaticProps as getStaticPropsHandler } from 'dataFetching/page/thai-results';
...
import { Desktop as ThailandResultsDesktop } from 'components/Pages/ThailandResults';
...
function Component(props: Props) {
  return (
    <Layout menu={props.menu}>
      {props.page && <ThailandResultsDesktop {...props} />}
    </Layout>
  );
}
