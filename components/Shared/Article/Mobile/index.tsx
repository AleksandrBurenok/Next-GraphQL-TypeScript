      ...
      <div className={styles.wrapper}>
        {date && (
          <div className={styles.date}>
            <Calendar width="12" height="12" className={styles.iconCalendar} />
            <span className={styles.dateText}>{formatDateWithYear(date)}</span>
          </div>
        )}
        {author && (
          <div className={styles.author}>
            <Author className={styles.iconAuthor} />
