...
import { getThailandLiveScore } from 'queries/livescore';
...
const useThailandTableData = ({ priorityLeagues, watch, section }: Props) => {
  ...
  const getData = useCallback(() => {
    setIsLoading(true);
    getThailandLiveScore(params).then((data) => {
...
export default useThailandTableData;
